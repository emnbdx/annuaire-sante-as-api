...
exports.select = async (param) => new Promise(
    (resolve, reject) => {
        ...
        connection.query("SELECT * FROM annuaire_sante WHERE lastname like '" + param + "%' LIMIT 5", handler);
    });

exports.insert = async (param) => new Promise(
    (resolve, reject) => {
        const handler = (error, result) => {
            if (error) {
                reject(error);
